...
sed -i 's|export KEY_PROVINCE="CA"|export KEY_PROVINCE="Albay"|' /etc/openvpn/easy-rsa/2.*/vars
sed -i 's|export KEY_CITY="SanFrancisco"|export KEY_CITY="Legazpi"|' /etc/openvpn/easy-rsa/2.*/vars
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="IIEE"|' /etc/openvpn/easy-rsa/2.*/vars
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="rdbtx123@gmail.com"|' /etc/openvpn/easy-rsa/2.*/vars
sed -i 's|export KEY_EMAIL=mail@host.domain|export KEY_EMAIL=rdbtx123@gmail.com|' /etc/openvpn/easy-rsa/2.*/vars
sed -i 's|export KEY_CN=changeme|export KEY_CN="Daybreakersx"|' /etc/openvpn/easy-rsa/2.*/vars
sed -i 's|export KEY_NAME="EasyRSA"|export KEY_NAME="server"|' /etc/openvpn/easy-rsa/2.*/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=Daybreakersx|' /etc/openvpn/easy-rsa/2.*/vars
